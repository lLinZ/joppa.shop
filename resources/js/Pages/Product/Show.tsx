...
export default function Show({ id }: { id: string }) {
    ...
    const handleAddToCart = () => {
        ...
        addToCart({
            ...
            brand: 'JOPPA',
            size: 'L' // You might want to add a size selector later
        });
    };
                            ...
                            <Box w="300px" style={{ position: 'sticky', top: '120px', height: 'calc(100vh - 140px)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                                <Box>
                                    ...
                                    <Group mt="2rem" gap="md">
                                        <Button onClick={handleAddToCart} variant="filled" color="#0B3022" radius="xl" size="lg" h={56} px={40} style={{ fontFamily: '"Montserrat", sans-serif', fontWeight: 500, fontSize: '1rem', backgroundColor: '#0B3022', color: '#FFFFFF' }}>
                                            Añadir a la Bolsa
                                        </Button>
                                    </Group>
                                </Box>
